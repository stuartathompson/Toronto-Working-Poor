...
$token = GoogleClientLogin("XXXusernameXXX", "XXXpasswordXXX", "fusiontables"); 
...
$thequerystring = "INSERT INTO 2891164 ('lat', 'lon', 'name', 'phone', 'email', 'age', 'desc', 'approved') VALUES ('" . $theLat . "', '" . $theLon . "', '" . $theName . "', '" . $thePhone . "', '" . $theEmail . "', '" . $theAge . "', '" . $theDesc . "', '0')";
echo $thequerystring;
